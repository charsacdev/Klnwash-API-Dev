...
<div class="email-div">
  <h1>Orders Notification with KLIN Wash</h1>

  <aside class="aside-1">
    <img src="{{asset('assets/emailicon.png')}}" class="emailicon">
    <br>
    <p>Hi,&nbsp;<b>{{ucwords($username)}}</b><br>
        Your order have been received successfully, we have generated a code associated with this order,check below for details.
    </p>
